...
.text 0
main:
  # carga num0 a num5 en los registros 9 a 1
...
salto:
  ...
  addi $t1, $t0, 4  # addi $r9,  $r8, 4  -> se ejecuta, r9  =  r8 + 4 = 19
  andi $t2, $t3, 3 # and $r10, $r11, 3 -> r10 = r11 and 3 = 100 and 011 = 0
  j final #salto incondicional
  add $t0, $s2, $s3   # add $r8,  $r18, $r19  -> se ejecuta, r8 = 3  
  add $t0, $s0, $s1   # add $r8,  $r16, $r17  -> se ejecuta, r8  = 15
  add $t0, $s2, $s3   # add $r8,  $r16, $r17  ->  no se ejecuta, r8 no cambia 
